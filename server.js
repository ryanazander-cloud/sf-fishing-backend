...
app.get('/tides-multi', async function(req, res) {
  try {
    ...
    const locations = [
      { id: 'golden_gate', name: 'Golden Gate', tideStation: '9414290', currentStation: 'PUG1515', datum: 'MLLW' },
      { id: 'alcatraz', name: 'Alcatraz', tideStation: '9414792', currentStation: 'SFB1211', datum: 'MLLW' },
      { id: 'pt_bonita', name: 'Pt. Bonita', tideStation: '9414290', currentStation: 'PUG1515', datum: 'MLLW', note: 'GG data, same water' },
    ];
